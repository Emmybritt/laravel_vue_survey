      ...
      <div class="py-5 px-8">
          ...
          <form v-else class="container mx-auto" @submit.prevent="submitSurvey">
              ...
              <div v-if="surveyFinished" class="py-8 px-6 bg-emerald-400 text-white w-[600px] mx-auto">
                  ...
                  <button @click="SubmitAnotherResponse" type="button" class="inline-flex justify-center 
              ...
              <div v-else>
                  ...
                  py-2 px-4 border border-transparent 
                  shadow-sm text-sm font-medium rounded-md
                  text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Submit</button>
              </div>
          </form>
      </div>
  </div>
